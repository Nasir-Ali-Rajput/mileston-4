...
window.addEventListener('load', () => {
    ...
    let resImag = document.getElementById('resImag');
    resImag.src = picture;
    ...
    let resInst3 = document.getElementById('resInst3');
    resInst3.textContent = inst3;
    let resPass4 = document.getElementById('resPass4');
    resPass4.textContent = pass4;
    let resDeg4 = document.getElementById('resDeg4');
    resDeg4.textContent = deg4;
    let resInst4 = document.getElementById('resInst4');
    resInst4.textContent = inst4;
    let resPass5 = document.getElementById('resPass5');
    resPass5.textContent = pass5;
    let resDeg5 = document.getElementById('resDeg5');
    resDeg5.textContent = deg5;
    let resInst5 = document.getElementById('resInst5');
    ...
    let resAchv11 = document.getElementById('resAchv11');
    resAchv11.textContent = achv11;
    let resAchv22 = document.getElementById('resAchv22');
    resAchv22.textContent = achv22;
    let resAchv33 = document.getElementById('resAchv33');
    ...
    let resAchv111 = document.getElementById('resAchv111');
    resAchv111.textContent = achv111;
    let resAchv222 = document.getElementById('resAchv222');
    resAchv222.textContent = achv222;
    let resAchv333 = document.getElementById('resAchv333');
